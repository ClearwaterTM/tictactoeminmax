...
public class TicTacToe extends AbstractGame{
	...
	{
		return(this.getCurrentPlayer().toString() + " joue un coup à l'endroit " + move + ".");
	}
	...
	public Game copy()
	{
		TicTacToe copiedGame = new TicTacToe(this.player1, this.player2);
		copiedGame.currentPlayer = super.currentPlayer;
		copiedGame.grid = new Player[3][3];
		...
		for (int a = 0; a < 3; a++)
		{
			for (int b = 0; b < 3; b++)
			{
				copiedGame.grid[a][b] = this.grid[a][b];
			}
		}
