...
public class Nim extends AbstractGame{
	...
	public Game copy()
	{
		Nim copiedGame = new Nim(this.getInitialNbMatches(), this.maxTakeSize, this.player1, this.player2);
		copiedGame.currentMatches = this.currentMatches;
